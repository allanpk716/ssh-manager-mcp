# Plan 43 — doctor serve 探活二期（绿/黄/红语义）设计 spec · rev2

- 日期：2026-08-28（rev2 同日：复审轮 2 家 8 条反馈闭环全吸收——含 3 处修法 owner 拍板；rev0→rev1 变更见 §9.1，rev1→rev2 见 §9.2）
...
- doctor 行渲染：internal 探针**不单独产行**，以 stderr 错误 + exit 2 表达。此语义写进帮助文本。
